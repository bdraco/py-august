...
from august.async_api import AsyncApi
...
class TestAuthenticatorAsync(aiounittest.AsyncTestCase):
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_should_refresh_when_token_expiry_is_after_renewal_threshold(
        self, mock_api
    ):
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_should_refresh_when_token_expiry_is_before_renewal_threshold(
        self, mock_api
    ):
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_refresh_token(self, mock_api):
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_get_session_with_authenticated_response(self, mock_api):
        self._setup_session_response(mock_api, True, True)
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_get_session_with_bad_password_response(self, mock_api):
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_get_session_with_requires_validation_response(self, mock_api):
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_get_session_with_already_authenticated_state(self, mock_api):
        self._setup_session_response(mock_api, True, True)
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_send_verification_code(self, mock_api):
        self._setup_session_response(mock_api, True, False)
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_validate_verification_code_with_no_code(self, mock_api):
        self._setup_session_response(mock_api, True, False)
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_validate_verification_code_with_validated_response(self, mock_api):
        self._setup_session_response(mock_api, True, False)
    ...
    @patch("august.api_async.AsyncApi")
    def async_test_validate_verification_code_with_invalid_code_response(
        self, mock_api
    ):
        self._setup_session_response(mock_api, True, False)
